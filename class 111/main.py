...
first_stddev_start,first_stddev_end=mean-std_deviation,mean+std_deviation
second_stddev_start,second_stddev_end=mean-(2*std_deviation),mean+(2*std_deviation)
third_stddev_start,third_stddev_end=mean-(3*std_deviation),mean+(3*std_deviation)
